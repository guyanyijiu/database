...
class Builder
{
     ...
     *
     * @param  \Closure|\guyanyijiu\Database\Query\Builder|string $query
     * @param  string  $as
     * @return \guyanyijiu\Database\Query\Builder|static
     *
...
//                    $query->{$method}(...array_values($value));
     ...
     *
     * @param  string   $column
     * @param  \guyanyijiu\Database\Query\Builder|static  $query
     * @param  string   $boolean
     * @param  bool     $not
     * @return $this
     */
...
//    }
     ...
     *
     * @param  \guyanyijiu\Database\Query\Builder|\Closure  $query
     * @param  bool  $all
     * @return \guyanyijiu\Database\Query\Builder|static
     */
     ...
     *
     * @param  array  $columns
     * @return \guyanyijiu\Support\Collection
     */
